  ...
  return (
    ...
    flex-col items-center justify-center gap-4'>
        ...
        <motion.h1
          ...
          className='text-3xl sm:text-6xl lg:text-[66x] font-Ovo'>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            transition={{duration:0.6,delay: 1}} 
             href='#contact' className='px-10 py-3 border border-white rounded-full border-gray-500 flex
            items-center gap-2 dark:bg-transparent'>contact me <Image src={assets.arrow_white} alt=''
